...
func _on_to_door_3_pressed() -> void: parent.switch_view(parent.RoomViews.DOOR_3)
...
func _on_to_guard_3_pressed() -> void: parent.switch_view(parent.RoomViews.GUARD_3)
